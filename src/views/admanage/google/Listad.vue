      ...
      <div class="list">
        <div class="title">
          <div class="left">
            ...
            <el-button
              v-if="businessType == 2 || selectval == 'campaignName'"
              class="title-btn"
              size="medium"
              plain
              @click="hangdleBtn(2)"
          ...
          >
            ...
            >
              <template #default="scope">
                ...
                <span v-else-if="item.name == '任务名称'">
                  <!-- {{scope.row.taskName}} -->
                  <el-popover
                    v-if="scope.row.taskName && scope.row.taskName.length > 20"
                    placement="top-start"
                    :width="200"
                    trigger="hover"
                  ...
                  >
                    <template #reference>
                      <div class="dy-cell w100">{{ scope.row.taskName }}</div>
                    </template>
                  </el-popover>
                  <div v-else>{{ scope.row.taskName }}</div>
                </span>
                <span v-else-if="item.name == '广告系列名称'">
                  <!-- {{scope.row.taskName}} -->
                  <el-popover
                    v-if="
                      scope.row.campaignName &&
                      scope.row.campaignName.length > 20
                    "
                    placement="top-start"
                    :width="200"
                    trigger="hover"
                    :content="scope.row.campaignName"
                  >
                    <template #reference>
                      <div class="dy-cell w100">
                        {{ scope.row.campaignName }}
                      </div>
                    </template>
                  </el-popover>
                  <div v-else>{{ scope.row.campaignName }}</div>
                </span>
...
export default defineComponent({
  ...
  setup () {
    ...
    const breadcrumbList = ['Google', '广告列表']
