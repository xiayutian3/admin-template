        ...
        >
          ...
          >
            <template #default="scope">
              ...
              <div v-else-if="item.name == '广告活动' || item.name == '广告组'">
                <el-button type="text" @click="goToDetailList">{{ scope.row[item.value] }}</el-button>
              </div>
...
export default defineComponent({
  ...
  setup (props, ctx) {
    ...
    const goToDetailList = () => {
      router.push('/home/amznSpListDetail')
    }
    // 导出数据
